...
extension Episode {
    static let all: [Episode] = [
        ...
        .init(titre: "ForEach",
              ...
              view: ForEachBasic()),
        .init(titre: "Bouton & @State",
              urlString: "https://www.youtube.com/watch?v=vk6YAOaEobA&t=24s",
              view: ButtonBasic()),
        .init(titre: "@Binding",
              urlString: "https://www.youtube.com/watch?v=Hfq9C4ifdEQ",
              view: BindingBasic(chanson: Chanson.exemple)),
        .init(titre: "Slider",
              urlString: "https://www.youtube.com/watch?v=nMrsd09rW58&t=75s",
              view: SliderBasic())
    ]
}
